...
<div id="content" class="container col-md-12">
	...
	<h1>Category Not Available
		<a href="add-subcategory.php">
			<button class="btn btn-danger">Add New SubCategory</button>
		</a>
	</h1>
	<hr />
	<?php 
	...
	<?php while ($stmt_paging->fetch()){ ?>
		<tr>
			...
			<td width="25%">
				<a href="edit-subcategory.php?id=<?php echo $data['Category_ID'];?>">
				Edit
				</a>&nbsp;
				<a href="delete-subcategory.php?id=<?php echo $data['Category_ID'];?>">
				Delete
				</a>
			</td>
		</tr>
	...
	<?php 
		...
		$function->doPages($offset, 'subcategory.php', '', $total_records, $keyword);?>
	</h4>
	</div>
